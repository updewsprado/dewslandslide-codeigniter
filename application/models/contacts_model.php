...
class Contacts_model extends CI_Model {
	...
	public function getOngoingEvents(){
		$query = $this->db->query("SELECT *,public_alert_trigger.timestamp from public_alert_event INNER JOIN public_alert_trigger ON public_alert_event.event_id=public_alert_trigger.event_id WHERE status='on-going' OR status='extended'");
		return $query;
	}

...
class Monitoring_Model extends CI_Model
{
	 ...
	 **/
	public function getOnGoingAndExtended($start, $end)
	{
		...
		$this->db->or_where("(public_alert_event.status = 'finished' AND public_alert_event.validity >= '$start' AND public_alert_event.validity < '$end')");
		$query = $this->db->get();

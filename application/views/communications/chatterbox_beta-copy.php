...
<!--
    Test Modal for Revised GroundMeas Reminder 3.0
-->
<div class="modal fade" id="ground-meas-reminder-modal-v3" tabindex="-1" role="dialog" aria-labelledby="groundMeasReminderModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="reminder-type" id="measurement-div">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <h4>Measurement Reminder Recipients</h4>
                                                        ...
                                                        <div class="col-md-6">
                                                            <h4>Measurement Reminder Message</h4>
                                                            <div class="form-group">
                                                                <label for="reminder-message" id="label-reminder-message">You can edit the message to be sent to the community. Note that any changes is recorded by the system.</label>
                                                                <textarea class="form-control" rows="8" id="reminder-message" placeholder=""></textarea>
                                                            </div>
                                            ...
                                            <div class="reminder-type" id="observation-div" >
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <h4>Observation Reminder Recipients</h4>
                                                            <label class="checkbox-inline">
                                                              <input type="checkbox" value="">AGB
                                                            </label>
                                                            <label class="checkbox-inline">
                                                        ...
                                                        <div class="col-md-6">
                                                            <h4>Observation Reminder Message</h4>
                                                            <div class="form-group">
                                                                <label for="reminder-message" id="label-reminder-message">You can edit the message to be sent to the community. Note that any changes is recorded by the system.</label>
                                                                <textarea class="form-control" rows="8" id="reminder-message" placeholder=""></textarea>
                                                            </div>
                                            ...
                                            </div>  <!-- End of observation tab div -->
                            ...
                            <div class="tab-pane fade" id="extended-tab-div">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="dropdown">
                                                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"  style="width: 100%;">Choose Reminder Type
                                                <span class="caret"></span></button>
                                                <ul class="dropdown-menu" style="width: 100%;">
                                                    <li><a id="meas-tab" href="#">Measurement Reminder</a></li>
                                                    <li><a id="obs-tab" href="#">Observation Reminder</a></li>
                                                </ul>
                                            </div>

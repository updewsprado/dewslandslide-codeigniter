...
<!-- <script type="text/javascript" src="/js/dewslandslide/data_analysis/dewsalertmini.js"></script> -->
    ...
    <div class="container-fluid">
                    ...
                    <div class="panel-heading">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                ...
                                <a class="nav-link" data-toggle="tab" href="#graph" role="tab"><i class=""></i>Site Details</a>
                            </li>
                            <li class="nav-item analysisgraph" id="liAnalisis">
                                <a class="nav-link active" data-toggle="tab" href="#graph1" role="tab"><i class=""></i> Site Maintenance History </a>
                            </li>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                         <h3 class="panel-title"><i class=""></i> Communication Health</h3>
                    </div>
                    <div class="panel-body">

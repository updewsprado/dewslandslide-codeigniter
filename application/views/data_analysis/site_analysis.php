          ...
          <div class="panel-body">
            <form class="col-xs-12">
              <div class="form-group reportrange0">
                ...
                <div id="reportrange0"  class="pull-right" style="background: #fff; cursor: pointer; padding: 0px 5px; border: 1px solid #ccc;width: 75%;font-family: sans-serif;font-size: 18px">
...
<div class="col-sm-12 svgBox" id="surfSvg">
  <svg id="surficialsvg" xmlns="http://www.w3.org/2000/svg" width="920" height ="1350"></svg>
</div>
...
<div class="col-sm-12 svgBox" id="subSvg">
  <svg id="subsurfacesvg" xmlns="http://www.w3.org/2000/svg" width="900" height ="2600"></svg>
</div>
<div class="col-sm-12 svgBox" id="aceSvg">
  <svg id="accelsvg" xmlns="http://www.w3.org/2000/svg" width="950" height ="1350"></svg>
</div>
...
<div class="modal fade" id="pdfModal" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal fade" id="groundModal_form" role="dialog">
      <div class="modal-dialog  modal-sm">
        <div class="modal-content">
          <div class="modal-body">
            <button type="button" class="close" data-dismiss="modal">&times;</button>

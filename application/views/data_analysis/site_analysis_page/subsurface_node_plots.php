	...
	<div id="subsurface-node-plots">
		...
		<div class="row">
			<div class="col-sm-12 text-center">
				<strong>X-Accelerometer Plot</strong>
			</div>
		</div>
		...
		<div id="x-accelerometer-plots"></div>
		...
		<div class="row">
			<div class="col-sm-12 text-center">
				<strong>Y-Accelerometer Plot</strong>
			</div>
		</div>
		...
		<div id="y-accelerometer-plots"></div>
		...
		<div class="row">
			<div class="col-sm-12 text-center">
				<strong>Z-Accelerometer Plot</strong>
			</div>
		</div>
		...
		<div id="z-accelerometer-plots"></div>
